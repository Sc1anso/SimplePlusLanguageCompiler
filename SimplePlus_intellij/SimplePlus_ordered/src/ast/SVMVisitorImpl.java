    ...
    public Void visitInstruction(SVMParser.InstructionContext ctx) { 
    	switch (ctx.getStart().getType()) {
			...
			case SVMLexer.BRANCHEQ:
                ...
                labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
                break;
			case SVMLexer.BRANCHNEQ:
				code[i++] = SVMParser.BRANCHNEQ;
				labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
				break;
			...
			case SVMLexer.BRANCHLESSEQ:
                ...
                labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
                break;
			case SVMLexer.BRANCHMORE:
				code[i++] = SVMParser.BRANCHMORE;
				labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
				break;
			case SVMLexer.BRANCHMOREQ:
				code[i++] = SVMParser.BRANCHMOREQ;
				labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
				break;
			case SVMLexer.BRANCHAND:
				code[i++] = SVMParser.BRANCHAND;
				labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
				break;
			case SVMLexer.BRANCHOR:
				code[i++] = SVMParser.BRANCHOR;
				labelRef.put(i++,(ctx.l!=null? ctx.l.getText():null));
				break;
			case SVMLexer.JS:
				code[i++] = SVMParser.JS;
			...
			case SVMLexer.STOREHP:
				...
				break;
			case SVMLexer.RETURN:
				code[i++] = SVMParser.RETURN;
				break;
